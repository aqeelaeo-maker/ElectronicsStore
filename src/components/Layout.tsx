...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex text-slate-100 relative overflow-hidden">
      ...
      <div className="absolute top-[35%] right-[15%] w-[35%] h-[35%] rounded-full bg-slate-700/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[25%] left-[20%] w-[30%] h-[30%] rounded-full bg-slate-800/5 blur-[110px] pointer-events-none" />
      ...
      <div className={cn(
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-white/5 bg-slate-950/40">
          <span className="text-xl font-extrabold tracking-tight text-white flex items-center gap-2">
            <span className="bg-gradient-to-r from-slate-700 to-slate-500 px-2 py-1 rounded-lg text-white font-black leading-none text-xs shadow-lg shadow-slate-950/40">EM</span>
            <span>Electro<span className="text-slate-300">Manage</span></span>
          </span>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive 
                      ? "bg-white/10 text-white border-white/25 shadow-lg shadow-slate-950/50 backdrop-blur-sm" 
        ...
        <div className="p-4 border-t border-white/5 bg-slate-950/40 backdrop-blur-md">
          <div className="flex items-center p-2 rounded-xl bg-white/5 border border-white/5 shadow-inner">
            <div className="flex-shrink-0">
              <div className="h-9 w-9 rounded-full bg-gradient-to-br from-slate-700 to-slate-600 flex items-center justify-center text-white font-bold shadow-lg shadow-slate-950/20">
          ...
          <div className="flex items-center space-x-4 ml-auto">
             ...
             <div className="hidden md:flex relative">
                <input 
                  ...
                  className="w-72 pl-4 pr-10 py-2 bg-slate-950/40 border border-white/5 hover:border-white/10 hover:bg-slate-950/60 focus:bg-slate-950/80 rounded-full text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/20 transition-all backdrop-blur-sm"
                />
             </div>
          </div>
        </header>
